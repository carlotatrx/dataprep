...
target_files = [
    'CHIMES_Marschlins_17820101-18710731_ta_subdaily_qc.tsv',
    'PALAEO-RA_Rovereto_1_17820214-18390827_ta_subdaily_qc.tsv',
    'SMI_Turin_17530101-18651130_ta_subdaily_qc.tsv',
    'Maugeri-et-al_Milan_17630101-19491231_ta_daily_qc.tsv',
    'Camuffo_Bologna_17150101-18151231_ta_daily_qc.tsv',
    'IMPROVE_Padua_17250112-19970531_ta_daily_qc.tsv',
]
files = [Path('/mnt/user-data/uploads/') / f for f in target_files]
stations = {}
for f in files:
    try:
...
plt.savefig('/home/claude/neighbor_validation.png', dpi=200, bbox_inches='tight')
plt.savefig('/home/claude/neighbor_validation.pdf', bbox_inches='tight')
print("\n✓ Figures saved")
