...
lat <- 51.550 # 51° 33' N
lon <- -9.150 # 9° 9' W
alt <- 5.5    # 18 feet converted to meters
metaHead <- "Observer=Coast-guard Boatmen | Instrument=Standardized RIA supply (George Yeates) | Location=Castletownsend Coast-guard Station, Co. Cork | DataSource=RIA Manuscripts 12M16"

raw <- read.csv(paste0(indir, name, "/Castletownsend_1850-1851.csv"),
