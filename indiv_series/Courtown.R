...
lat <- 52.650 # 52° 39' N
lon <- -6.217 # 6° 13' W
alt <- 10.4   # 34 feet converted to meters
metaHead <- "Observer=Coast-guard Boatmen | Instrument=Standardized RIA supply (George Yeates) | Location=Courtown Coast-guard Station, Co. Wexford | DataSource=RIA Manuscripts 12M16"
raw <- read.csv(paste0(indir, name, "/Courtown_1850-1852.csv"),
