...
metaHead <- paste0(
  ...
  "Location=Innisgort Lighthouse, Clew Bay | DataSource=Royal Irish Academy network | Notes=",
  "whole degree precision."
)

raw <- read.csv(paste0(indir, name, "/Innisgort Island_1851-1852.csv"), header=FALSE,
