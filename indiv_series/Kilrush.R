...
metaHead <- paste0(
  ...
  "Location=Kilrush coast-guard station | Notes=",
  "mixed precision (0.1F early, whole degrees later)."
)
metaHead
  

raw <- read.csv(paste0(indir, name, "/Kilrush_1850-1851.csv"), header=FALSE,
